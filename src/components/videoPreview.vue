<template>
    ...
    >
        ...
        <el-dialog fullscreen :visible="show" :show-close="false" @opened="this.opendialog">

            <i class="el-dialog__close el-icon el-icon-close" @click="this.closeDialog"  />
...
export default {
    ...
    watch: {
        bgImage(newVal, oldVal) {
            ...
            if (newVal != "") {
                ...
                this.$refs.previewComponents.style.backgroundRepeat =
                    "no-repeat";
                this.$refs.previewComponents.style.backgroundPosition =
                    "center";
    ...
    methods: {
        ...
        addedcontenainers() {
            ...
            this.$refs.contenainers.style.setProperty(
                "justify-content",
                "center"
            );
